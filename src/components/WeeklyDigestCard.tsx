...
/**
 * Render a "Weekly Digest" card that displays the week's date range, four key stats, and an AI-generated summary.
 *
 * The card handles loading and empty states, provides a control to generate or refresh the digest (sends a POST to /api/digest/generate), and allows toggling an expanded AI summary view.
 *
 * @param babyId - Optional baby identifier used to scope the digest data
 * @returns The card element containing loading/empty fallbacks, stats, and the digest summary
 */
