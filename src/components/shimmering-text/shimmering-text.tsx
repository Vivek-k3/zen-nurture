...
/**
 * Renders text with a per-character shimmering effect.
 *
 * Each character is animated independently to create a wave-like shimmer that
 * cycles through configured CSS color variables.
 *
 * @param text - The string to render with the shimmering effect
 * @param duration - Duration in seconds of one shimmer cycle (default: 1)
 * @param isStopped - When true, pauses the shimmer and displays the base color (default: false)
 * @returns A motion-enabled span containing the text split into animated character spans
 */
