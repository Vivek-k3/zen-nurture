...
/**
 * Renders the authenticated application chrome around page content, including sidebars, desktop and mobile headers, a floating quick-log action, and the QuickLogger and Mora drawers while managing their open/close state and focus restoration.
 *
 * The component listens for a global "openQuickLogger" event to prefill and open the QuickLogger drawer, provides controls to toggle the Mora sidebar and QuickLogger drawer (ensuring only one is open at a time), and returns focus to the Mora trigger when the Mora sidebar is closed.
 *
 * @returns The React element that composes the authenticated layout and renders the provided children within it
 */
