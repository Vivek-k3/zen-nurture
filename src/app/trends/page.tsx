...
/**
 * Render the Trends & Analysis page that displays growth charts, aggregate metrics, and filtering controls for the active baby.
 *
 * The component provides time-range tabs (24h, 7d, 14d, 30d, Growth), diaper/formula/feed/medicine filters, a Weekly Digest card, and three data views:
 * - 24h: summary metric cards for feeds, diapers, sleep, and meds
 * - 7/14/30d: trend charts for the selected range
 * - Growth: growth charts and latest measurements
 *
 * Data is fetched and filtered for the active baby; diaper events are further filtered on the client according to the selected diaper filters and toggles.
 *
 * @returns The component's rendered JSX element, or `null` before the client mount is complete.
 */
